...
<body>
  ...
  <div id="map" class="map full">
    ...
    <button id="btn4" class="btn btn-danger btn-circle-preset glow" type="button">!</button>
    <button id="btn5" class="btn btn-danger btn-circle-preset glow" type="button">!</button>
    <button id="btn6" class="btn btn-danger btn-circle-preset glow" type="button">!</button>
    <button id="btn7" class="btn btn-danger btn-circle-preset glow" type="button">!</button>
    <button id="btn8" class="btn btn-danger btn-circle-preset glow" type="button">!</button>
    <button id="btn9" class="btn btn-danger btn-circle-preset glow" type="button">!</button>
    <button id="btn10" class="btn btn-danger btn-circle-preset glow" type="button">!</button>
    <button id="egg" class="btn btn-danger btn-circle-preset glow" type="button" onclick="tell()">?</button>
  </div>
  ...
  <script src="script.js?v=2.0" charset="utf-8"></script>
</body>
